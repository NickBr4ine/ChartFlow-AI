...
const PERIOD_LABELS: Record<MovingAveragePeriod, string> = {
  20: "SMA 20",
  93: "SMA 93",
  230: "SMA 230"
};

const PERIOD_DESCRIPTIONS: Record<MovingAveragePeriod, string> = {
...
export function buildIndicatorSummary(
  ...
  return {
    ...
    average,
    relation,
    description: `${direction} - ${PERIOD_DESCRIPTIONS[period]}`
  };
}
